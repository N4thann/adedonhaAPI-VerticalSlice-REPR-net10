...
{
    public class GetCategoryWordCountsUseCaseTests
    {
        ...
        private readonly ILogger<GetCategoryWordCountsUseCase> _loggerMock;
        private readonly GetCategoryWordCountsUseCase _sut;

        public GetCategoryWordCountsUseCaseTests()
        {
            ...
            _loggerMock = Substitute.For<ILogger<GetCategoryWordCountsUseCase>>();
            _unitOfWorkMock.Categories.Returns(_categoryRepoMock);
            _unitOfWorkMock.Words.Returns(_wordRepoMock);
            _sut = new GetCategoryWordCountsUseCase(_unitOfWorkMock, _requestContextMock, _loggerMock);
        }
        ...
        public async Task ExecuteAsync_WhenCategoriesAndWordsExist_ShouldReturnCountsSortedDescendingExcludingZero()
        {
            ...
            // Act
            var result = await _sut.ExecuteAsync(new GetCategoryWordCountsInput(), CancellationToken.None);
